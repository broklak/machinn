                        ...
                        <form id="form-wizard" class="form-horizontal" action="{{route("$route_name.update", ['id' => $row->id])}}" method="post">
                            ...
                            <div id="form-wizard-1" class="step">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input @if($row->type == 1) checked @endif type="radio" value="1" name="type" id="food"><label style="display: inline-table;vertical-align: sub;margin: 0 10px" for="food">Food</label>
                                        <input @if($row->type == 2) checked @endif type="radio" value="2" name="type" id="beve"><label style="display: inline-table;vertical-align: sub;margin: 0 10px" for="beve">Beverages</label>
                                    </div>
                                </div>
                                <div class="control-group">
