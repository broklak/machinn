                            ...
                            <div id="form-wizard-1" class="step">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input @if(old('type') == 2) checked @endif type="radio" value="2" name="type" id="banq"><label style="display: inline-table;vertical-align: sub;margin: 0 10px" for="banq">Banquet</label>
                                    </div>
                                </div>
                            </div>
