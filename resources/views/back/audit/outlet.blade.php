                        ...
                        <div class="tab-pane active">
                            <form method="post" action="{{route('back.night.outlet.process')}}">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($rows as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <input value="{{$value->transaction_id}}" data-total={{$value->grand_total}} onclick="addTotal($(this))" type="checkbox" @if($value->audited == 1) disabled checked @endif name="audit[]">
                                                @endif
                                            </td>
                                        </tr>
                                    ...
                                    @endforeach
                                    <tr>
                                      <td colspan="5" style="text-align: right">Total @lang('web.transaction')</td>
                                      <td style="text-align: right">{{\App\Helpers\GlobalHelper::moneyFormat($total)}}</td>
                                    </tr>
                                    <tr>
                                      <td colspan="5" style="text-align: right">Total Audit</td>
