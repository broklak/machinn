...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route("$route_name.index")}}">@lang('web.ccType')</a> <a href="#" class="current">@lang('web.add') @lang('web.ccType')</a> </div>
                        ...
                        <form id="form-wizard" class="form-horizontal" action="{{route("$route_name.store")}}" method="post">
                            ...
                            <div class="step">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="name" required type="text" style="width: 30em" name="cc_type_name" />
                                    </div>
                                </div>
                            </div>
