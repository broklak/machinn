                                ...
                                @foreach($rows as $val)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('You will delete {{$val->partner_group_name}}, continue? ')"
                                            ...
                                            @if($val->partner_group_status == 0)
                                                <a onclick="return confirm('You will activate {{$val->partner_group_name}}, continue? ')" href="{{route("$route_name.change-status", ['id' => $val->partner_group_id, 'status' => $val->partner_group_status])}}"><i class="icon-check" aria-hidden="true"></i> Set Active</a>
                                            @else
                                                <a onclick="return confirm('You will deactivate {{$val->partner_group_name}}, continue? ')" href="{{route("$route_name.change-status", ['id' => $val->partner_group_id, 'status' => $val->partner_group_status])}}"><i class="icon-remove" aria-hidden="true"></i> Set Not Active</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
