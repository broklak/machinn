...
@section('content')
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route("$route_name.index")}}">Role</a> <a href="#" class="current">Create Role</a> </div>
