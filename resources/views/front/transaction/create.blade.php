                        ...
                        <form id="form-wizard" class="form-horizontal" action="{{route("$route_name.store")}}" method="post">
                            ...
                            <div id="form-wizard-1" class="step">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input @if(old('type') == 1) checked @endif type="radio" value="1" name="status" id="app"><label style="display: inline-table;vertical-align: sub;margin: 0 10px" for="gua">Approved</label>
                                        <input @if(old('type') == 2 || old('status') == null) checked @endif type="radio" value="2" name="status" id="napp"><label style="display: inline-table;vertical-align: sub;margin: 0 10px" for="ten">Not Approved</label>
                                    </div>
                                </div>
                            </div>
